...
Config.Stations = {
    ...
    ['RADIO_05_TALK_01']               = { label = 'West Coast Talk Radio',     logo = nil,                          genre = 'Talk' },
    ...
    ['RADIO_21_DLC_XM17']              = { label = 'Blonded Los Santos 97.8',   logo = nil,                          genre = 'Contemporary' },
    ['RADIO_22_DLC_BATTLE_MIX1_RADIO'] = { label = 'LS Underground Radio',      logo = nil,                          genre = 'House' },
    ['RADIO_23_DLC_XM19_RADIO']        = { label = 'iFruit Radio',              logo = nil,                          genre = 'Alternative' },
    ['RADIO_27_DLC_PRHEI4']            = { label = 'Still Slipping Los Santos', logo = nil,                          genre = 'Hip Hop' },
    ['RADIO_34_DLC_HEI4_KULT']         = { label = 'Kult FM',                   logo = nil,                          genre = 'Post-Punk' },
    ['RADIO_35_DLC_HEI4_MLR']          = { label = 'The Music Locker',          logo = nil,                          genre = 'House' },
    ['RADIO_36_AUDIOPLAYER']           = { label = 'Media Player',              logo = nil,                          genre = 'Custom' },
    ['RADIO_37_MOTOMAMI']              = { label = 'MOTOMAMI Los Santos',       logo = nil,                          genre = 'Latin' },
}
